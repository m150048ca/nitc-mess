		...
		<div class="panel panel-success">
			  ...
			  <div class="panel-body"> 
				<ul class="list-group">
					...
					<li class="list-group-item"><a href="messmega.php#hofficewarder">Hostel Office Wardern</a></li>
					<li class="list-group-item"><a href="messmega.php#about">Contact webmaster  </a></li>
					<li class="list-group-item"><a href="messmega.php#time">Time table</a></li>
					<li class="list-group-item"><a href="messmega.php#menu">Menu-List</a></li>
				  </ul>
	...
	<div class="col col-sm-6">
		<div class="row"><!-- About NITC -->
        	<div class="col col-sm-12 col-lg-12 col-xl-12 col-md-12">
        		<div id="about-nitc">
                <h3 align="center">Welcome to MEGA BOYS mess</h3>
		...
		<div class="row"><!-- Content Part starts from here -->
			<div class="col col-sm-12 col-lg-12 col-xl-12 col-md-12">
                ...
                <section>
                    ...
                    <h2>Contact Hostel  MEGA Warden Office</h2>
