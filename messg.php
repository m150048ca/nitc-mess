		...
		<div class="panel panel-success">
			  ...
			  <div class="panel-body"> 
				<ul class="list-group">
					...
					<li class="list-group-item"><a href="messg.php#hofficewarder">Hostel Office Wardern</a></li>
					<li class="list-group-item"><a href="messg.php#about">Contact  webmaster  </a></li>
					<li class="list-group-item"><a href="messg.php#time">Time table</a></li>
					<li class="list-group-item"><a href="messg.php#menu">Menu-List</a></li>
				  </ul>
	...
	<div class="col col-sm-6">
		<div class="row"><!-- About NITC -->
        	<div class="col col-sm-12 col-lg-12 col-xl-12 col-md-12">
        		<div id="about-nitc">
                <h3 align="center">Welcome to G mess</h3>
			...
			<div class="col col-sm-12 col-lg-12 col-xl-12 col-md-12">
                ...
                <section>
                    ...
                    <p class="lead">National Institute of Technology Calicut Hostels</p>
                     ...
                     <img src="assets/mess_images/g-mess.jpg"  id="mess_img" alt="paralex image " class="img img-responsive img-thumbnail" width="100%">
				...
				<div id="hofficewarder">
                    <h2>Contact Hostel  G Warden Office</h2>
					  <div class="col col-sm-6">
                    	...
                    	<p>Dr.Sreenath</p>
                         ...
                         <p>Ass.pfof.MED</p>                   
                        <p>0495 2286219, 9447581235(Office)</p>
                    ...
                    <div class="col col-sm-6">
                    <h3>  G Hostel contractor </h3>
                    	<p>mr.Sathyanadan</p>
                    
                    
                        <p>9904523033</p>
                        <p>Email:sathyandan76@gmail.com</p>
