		...
		<div class="panel panel-success">
			  ...
			  <div class="panel-body"> 
				<ul class="list-group">
					...
					<li class="list-group-item"><a href="messc.php#hofficewarder">Hostel Office Wardern</a></li>
					<li class="list-group-item"><a href="messc.php#about">Contact Webmaster</a></li>
					<li class="list-group-item"><a href="messc.php#time">Time table</a></li>
					<li class="list-group-item"><a href="messc.php#menu">Menu-List</a></li>
				  </ul>
	...
	<div class="col col-sm-6">
		<div class="row"><!-- About NITC -->
        	<div class="col col-sm-12 col-lg-12 col-xl-12 col-md-12">
        		<div id="about-nitc">
                <h3 align="center">Welcome to C mess</h3>
		...
		<div class="row"><!-- Content Part starts from here -->
			<div class="col col-sm-12 col-lg-12 col-xl-12 col-md-12">
                ...
                <section>
                    ...
                    <img src="assets/mess_images/c-mess.jpg"  id="mess_img" alt="paralex image " class="img img-responsive img-thumbnail" width="100%">
					 </section>
                    <h2>Contact Hostel  C Warden Office</h2>
					
                   
                    <div class="col col-sm-6">
                    
                    	<h3 > Warden</h3>
                    	<p> Dr.Santhosh G Thamb Prof. CED</p>
                    
                    
                        <p>0495 2286206, 9447581218(Office)</p>
                        <p>Email: sntosh@nitc.ac.in</p>
                    </div>
					<div class="col col-sm-6">
                    
                    	<h3 > Warden</h3>
                    	<p>Dr.Sathish Kumar D, CED</p>
                    <p> 9447581218(Office)</p>
                        <p>Email: satih@nitc.ac.in</p>
                    </div>
                    <br/>
                    <h3>  C Hostel contractor </h3>
                    
                    <div class="col col-sm-6">
                    
                    	<p>mr.Narendra sharma</p>
                    
                    
                        <p>9061456789</p>
                        <p>Email:narendra@nitc.ac.in</p>
