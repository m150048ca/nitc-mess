		 ...
		 <ul class="nav navbar-nav">
			...
			<li class="dropdown">
			  ...
			  <ul class="dropdown-menu">
				<li><a href="index.php#login-register" onClick="messegelogin();"><span class="glyphicon glyphicon-ok-circle">&ensp;</span>Feedback</a></li>
				<li><a href="index.php#login-register" onClick="messegelogin();"><span class="glyphicon glyphicon-hand-down">&ensp;</span>Suggestion</a></li>
				<li><a href="index.php#login-register" onClick="messegelogin();"><span class="glyphicon glyphicon-thumbs-down">&ensp;</span>Complaint</a></li>
				<li><a href="#footer"><span class="glyphicon glyphicon-thumbs-up">&ensp;</span>Like</a></li>
			...
			<li class="dropdown">
			  ...
			  <ul class="dropdown-menu">
				...
				<li><a href="messd.php">Mess D</a></li>
				<li><a href="messe.php">Mess E</a></li>
				<li><a href="messf.php">Mess F</a></li>
				<li><a href="messg.php">Mess G</a></li>
				<li><a href="messinternational.php.php">Mess International</a></li>
				<li><a href="messladies.php">Mess Ladies</a></li>
				<li><a href="messmba.php">Mess MBA</a></li>
				<li><a href="messmega.php">Mess MEGA</a></li>
				<li><a href="messpg1.php">Mess PG1</a></li>
				<li><a href="messpg2.php">Mess PG2</a></li>
			  </ul>
			</li>

			 <li><a href="index.php#login-register"><span class="glyphicon glyphicon-log-in">&ensp;</span>Login</a></li>
	...
	<div class="col col-sm-3 col-xl-3">
		<div class="panel panel-danger">
			  ...
			  <div class="panel-body"> 
				...
				<li class="list-group-item"><span class="glyphicon glyphicon-user">&nbsp;</span><a href="http://www.dss.nitc.ac.in/">NITC DSS</a></li>

				<li class="list-group-item"><span class="glyphicon glyphicon-user">&nbsp;</span><a href="http://www.sgc.nitc.ac.in/">Student Guidence Cell </a></li>
				
				<li class="list-group-item"><span class="glyphicon glyphicon-user">&nbsp;</span><a href="http://www.nitc.ac.in/GIAN/">GIAN </a></li>

				<li class="list-group-item"><span class="glyphicon glyphicon-user">&nbsp;</span><a href="files/requicision_slip.pdf">Requisition slip</a></li>

				<li class="list-group-item"><a href="index.html#login-register"><span class="glyphicon glyphicon-log-in">&ensp;</span>Login to NITC MESS</a></li>
		...
		<form class="form-horizontal" action="forgot.php" method="post">
			<div class="form-group">
              ...
              <div class="form-group">
                  <label for="username" class="col-sm-3 control-label">user name *</label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" id="fusername" placeholder="SID or CID" name="fusername" required>
                  </div>
			  </div>
              <div class="form-group">
				<div class="col col-sm-7 pull-right">
