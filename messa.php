		...
		<div class="panel panel-success">
			  ...
			  <div class="panel-body"> 
				<ul class="list-group">
					...
					<li class="list-group-item"><a href="messa.php#hofficewarder">Hostel Office Wardern</a></li>
					<li class="list-group-item"><a href="messa.php#about">Contact Webmaster</a></li>
					<li class="list-group-item"><a href="messa.php#time">Time table</a></li>
					<li class="list-group-item"><a href="messa.php#menu">Menu-List</a></li>
				  </ul>
	...
	<div class="col col-sm-6">
		<div class="row"><!-- About NITC -->
        	<div class="col col-sm-12 col-lg-12 col-xl-12 col-md-12">
        		<div id="about-nitc">
                <h3 align="center">Welcome to A mess</h3>
			...
			<div class="col col-sm-12 col-lg-12 col-xl-12 col-md-12">
                ...
                <section>
                    ...
                    <p class="lead">National Institute of Technology Calicut Hostels</p>
                     <img src="assets/mess_images/a-mess.jpg"  id="mess_img" alt="paralex image " class="img img-responsive img-thumbnail" width="100%">
                  </section>
                    <h2>Contact Hostel  A Warden Office</h2>
					
                      <div class="col col-sm-6">
                    
                    	<h3 > Warden</h3>
                    	<p>Mr. George K. Varghese.</p>
                    
                    
                        <p>0495 2286206, 9447581218(Office)</p>
                        <p>Email: gkv@nitc.ac.in</p>
                    </div>
					<div class="col col-sm-6">
                    
                    	<h3 > Warden</h3>
                    	<p>Dr.Rajanikant G. K</p>
                    
                    
                        <p>0495 2285452 (O) 9495204863</p>
                        <p>Email: rajnikant@nitc.ac.in</p>
                    </div>
                    
                    <h3>  A Hostel contractor </h3>
                    ...
                    <div class="col col-sm-6">
                        ...
                        <p>9904523098,9087654334</p>
                        <p>Email:ranjeet@nitc.ac.in</p>
                ...
                <div id="time">
					...
					<br/>
					<br/>
					<h3>  A mess time table </h3>
							
					<table border id="bor" class="table table-hover">
