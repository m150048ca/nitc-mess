		...
		<div class="panel panel-success">
			  ...
			  <div class="panel-body"> 
				<ul class="list-group">
					...
					<li class="list-group-item"><a href="messf.php#hofficewarder">Hostel Office Wardern</a></li>
					<li class="list-group-item"><a href="messf.php#about">Contact Webmaster</a></li>
					<li class="list-group-item"><a href="messf.php#time">Time table</a></li>
					<li class="list-group-item"><a href="messf.php#menu">Menu-List</a></li>
				  </ul>
	...
	<div class="col col-sm-6">
		<div class="row"><!-- About NITC -->
        	<div class="col col-sm-12 col-lg-12 col-xl-12 col-md-12">
        		<div id="about-nitc">
                <h3 align="center">Welcome to F mess</h3>
		...
		<div class="row"><!-- Content Part starts from here -->
			<div class="col col-sm-12 col-lg-12 col-xl-12 col-md-12">
                ...
                <section>
                    ...
                    <img src="assets/mess_images/f-mess.jpg"  id="mess_img" alt="paralex image " class="img img-responsive img-thumbnail" width="100%">
					
                    </section>
			<div id="hofficewarder">
				<h2>Contact Hostel  F Warden Office</h2>
					
                   
                    <div class="col col-sm-6">
                    
                    	<h3 > Warden</h3>
                    	<p>Dr. Praveen Sankaran.</p>
                    
                         <p>Ass.pfof.ECED</p>                   
                        <p>0495 2286217, 9447581230(Office)</p>
                    ...
                    <div class="col col-sm-6">
                    <h3>  F Hostel contractor </h3>
                    	<p>mr.narayana kutty p.</p>
                    
                    
                        <p>9904523023</p>
                        <p>Email:narayan011@gmail.com</p>
