		...
		<div class="panel panel-success">
			  ...
			  <div class="panel-body"> 
				<ul class="list-group">
					...
					<li class="list-group-item"><a href="messmba.php#hofficewarder">Hostel Office Wardern</a></li>
					<li class="list-group-item"><a href="messmba.php#about">Contact webmaster  </a></li>
					<li class="list-group-item"><a href="messmba.php#time">Time table</a></li>
					<li class="list-group-item"><a href="messmba.php#menu">Menu-List</a></li>
				  </ul>
	...
	<div class="col col-sm-6">
		<div class="row"><!-- About NITC -->
        	<div class="col col-sm-12 col-lg-12 col-xl-12 col-md-12">
        		<div id="about-nitc">
                <h3 align="center">Welcome to MBA mess</h3>
			...
			<div class="col col-sm-12 col-lg-12 col-xl-12 col-md-12">
                ...
                <section>
                    ...
                    <p class="lead">National Institute of Technology Calicut Hostels</p>
                     ...
                     <img src="assets/mess_images/mba.jpg"  id="mess_img" alt="paralex image " class="img img-responsive img-thumbnail" width="100%">
					 </section>
					<br/>
					
					<div id="hofficewarder">
                    <h2>Contact Hostel MBA Warden Office</h2>
					
                   
                    <div class="col col-sm-6">
                    
                    	<h3 > Warden</h3>
                    	<p>Dr.k.Muhanmmadshafi</p>
                            
                        <p>2286076(O), 8943001345</p>
