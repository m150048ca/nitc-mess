		 ...
		 <ul class="nav navbar-nav">
			...
			<li class="dropdown">
			  ...
			  <ul class="dropdown-menu">
				...
				<li><a href="messdmega.php">Mess MEGA</a></li>
		...
		<div class="panel panel-success">
			  ...
			  <div class="panel-body"> 
				<ul class="list-group">
					...
					<li class="list-group-item"><a href="messladies.php#hofficewarder">Hostel Office Wardern</a></li>
					<li class="list-group-item"><a href="messladies.php#about">Contact webmaster  </a></li>
					<li class="list-group-item"><a href="messladies.php#time">Time table</a></li>
					<li class="list-group-item"><a href="messladies.php#menu">Menu-List</a></li>
				  </ul>
	...
	<div class="col col-sm-6">
		<div class="row"><!-- About NITC -->
        	<div class="col col-sm-12 col-lg-12 col-xl-12 col-md-12">
        		<div id="about-nitc">
                <h3 align="center">Welcome to LADIES mess</h3>
			...
			<div class="col col-sm-12 col-lg-12 col-xl-12 col-md-12">
                ...
                <section>
                    ...
                    <p class="lead">National Institute of Technology Calicut Hostels</p>
                     ...
                     <img src="assets/mess_images/girls.jpg"  id="mess_img" alt="paralex image " class="img img-responsive img-thumbnail" width="100%">
					 </section>
					<br/>
					
					<div id="hofficewarder">
                    <h2>Contact Hostel LADIES Warden Office</h2>
					
                   
                    <div class="col col-sm-6">
                    
                    	<h3 > Warden</h3>
                    	<p>Dr. S. Bhuvaneshwari</p>
                          <p>Asst. Proff. CHE DEP</p>              
                        <p>0495 2285402(O), 8891499076,</p>
                        <p>Email: sbuvana@nitc.ac.in</p>
                    </div>
					 <div class="col col-sm-6">
                    
                    	<h3 > Warden</h3>
                    	<p>Dr.Pramada S. K.</p>
                         <p> Ass Proff Civil Engi Depart</p>               
                        <p>0495 2286218(O), 9656006952</p>
                        <p>Email: pramada@nitc.ac.in</p>
                    </div>
                   ...
                   <br/>
                  <div id="con">				   
                    <h3> LADIES Hostel contractor </h3>
                    
                    
                    <div class="col col-sm-6">
                    
                    	<p>mr.Amrendra pratap</p>
