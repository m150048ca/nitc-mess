		...
		<div class="panel panel-success">
			  ...
			  <div class="panel-body"> 
				<ul class="list-group">
					...
					<li class="list-group-item"><a href="messinternational.php#hofficewarder">Hostel Office Wardern</a></li>
					<li class="list-group-item"><a href="messinternational.php#about">Contact webmaster  </a></li>
					<li class="list-group-item"><a href="messinternational.php#time">Time table</a></li>
					<li class="list-group-item"><a href="messinternational.php#menu">Menu-List</a></li>
				  </ul>
	...
	<div class="col col-sm-6">
		<div class="row"><!-- About NITC -->
        	<div class="col col-sm-12 col-lg-12 col-xl-12 col-md-12">
        		<div id="about-nitc">
                <h3 align="center">Welcome to INTERNATIONAL mess</h3>
		...
		<div class="row"><!-- Content Part starts from here -->
			<div class="col col-sm-12 col-lg-12 col-xl-12 col-md-12">
                ...
                <section>
                    ...
                    <h2>Contact Hostel INTERNATIONAL Warden Office</h2>
					
                   
                    <div class="col col-sm-6">
                    
                    	<h3 > Warden</h3>
                    	<p>Mr.padmanaabhan V</p>
                                       
                        <p>0495 2286970</p>
                        <p>Email: pada@nitc.ac.in</p>
                    </div>			   
                    
                    
                    
                    <div class="col col-sm-6">
                    <h3> INTERNATIONAL Hostel contractor </h3>
                    	<p>mr.AnwarSadath</p>
                ...
                <div id="time">
					...
					<br/>
					<br/>
					<h3>  INTERNATIONAL mess time table </h3>
			   ...
			   <div id="menu">
					...
					<h3>  INTERNATIONAL Mess Menu-List </h3>
