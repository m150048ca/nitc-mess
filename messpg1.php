		...
		<div class="panel panel-success">
			  ...
			  <div class="panel-body"> 
				<ul class="list-group">
					...
					<li class="list-group-item"><a href="messpg1.php#hofficewarder">Hostel Office Wardern</a></li>
					<li class="list-group-item"><a href="messpg1.php#about">Contact webmaster  </a></li>
					<li class="list-group-item"><a href="messpg1.php#time">Time table</a></li>
					<li class="list-group-item"><a href="messpg1.php#menu">Menu-List</a></li>
				  </ul>
	...
	<div class="col col-sm-6">
		<div class="row"><!-- About NITC -->
        	<div class="col col-sm-12 col-lg-12 col-xl-12 col-md-12">
        		<div id="about-nitc">
                <h3 align="center">Welcome to PG-I mess</h3>
			...
			<div class="col col-sm-12 col-lg-12 col-xl-12 col-md-12">
                ...
                <section>
                    ...
                    <p class="lead">National Institute of Technology Calicut Hostels</p>
                     ...
                     <img src="assets/mess_images/pg-1.jpg"  id="mess_img" alt="paralex image " class="img img-responsive img-thumbnail" width="100%">
					 </section>
					<br/>
					
					<div id="hofficewarder">
                    <h2>Contact Hostel PG-I Warden Office</h2>
					
                   
                    <div class="col col-sm-6">
                    
                    	<h3 > Warden</h3>
                    	<p>Dr.  Aji A. Anappara</p>
                          <p>Asst. Proff. PHY</p>              
                        <p>0495 2285107 (O) 9400420666</p>
                        <p>Email: aji@nitc.ac.in</p>
                    </div>
					 <div class="col col-sm-6">
                        ...
                        <p>0495 2286711(O)</p><p> 9446063328</p>
                        <p>Email: arun@nitc.ac.in</p>
                    </div>
