		...
		<div class="panel panel-success">
			  ...
			  <div class="panel-body"> 
				<ul class="list-group">
					...
					<li class="list-group-item"><a href="messb.php#hofficewarder">Hostel Office Wardern</a></li>
					<li class="list-group-item"><a href="messb.php#about">Contact Webmaster</a></li>
					<li class="list-group-item"><a href="messb.php#time">Time table</a></li>
					<li class="list-group-item"><a href="messb.php#menu">Menu-List</a></li>
				  </ul>
	...
	<div class="col col-sm-6">
		<div class="row"><!-- About NITC -->
        	<div class="col col-sm-12 col-lg-12 col-xl-12 col-md-12">
        		<div id="about-nitc">
                <h3 align="center">Welcome to B mess</h3>
		...
		<div class="row"><!-- Content Part starts from here -->
			<div class="col col-sm-12 col-lg-12 col-xl-12 col-md-12">
                ...
                <section>
                    ...
                    <img src="assets/mess_images/b-mess.jpg"  id="mess_img" alt="paralex image " class="img img-responsive img-thumbnail" width="100%">
                    <h2>Contact Hostel  B Warden Office</h2>
					
                   
                    <div class="col col-sm-6">
                    
                    	<h3 > Warden</h3>
                    	<p>Mr.Bimal P, Asst. Prof. Arc</p>
                    
                    
                        <p>0495 2286909(O) 8891000580</p>
                        <p>Email: bim@nitc.ac.in</p>
                    </div>
					<div class="col col-sm-6">
                    
                    	<h3 > Warden</h3>
                    	<p>Mr. V Sakthivel, Asst. Prof. ECED</p>
                    
                    
                        <p>04952286730 (O) 9995335962</p>
                        <p>Email: Vskth@nitc.ac.in</p>
                    </div>
                    
                    <h3>  B Hostel contractor </h3>
                    ...
                    <div class="col col-sm-6">
                        ...
                        <p>9344523098,9089654334</p>
                        <p>Email:mahesh@nitc.ac.in</p>
                ...
                <div id="time">
					...
					<br/>
					<br/>
					<h3>  B mess time table </h3>
							
					<table border="10" height="100px" width="670px" id="bor">
			   ...
			   <div id="menu">
					...
					<h3>  B Mess Menu-List </h3>
									
					<table border="10" height="400px" width="670px"  >
